...
export default function SceneCard() {
  ...
  useEffect(() => {
    try {
      const l = localStorage.getItem("settings_landing");
      if (l) setLanding(JSON.parse(l));
      const i = localStorage.getItem("settings_introStyle");
      if (i) setIntroStyle(JSON.parse(i));
    } catch {}
  }, []);
